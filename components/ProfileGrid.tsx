...
const profiles = [
  {
    ...
    bio: "Brendan Cleaves is a UK-based writer-director crafting genre-bending stories where the ordinary slips into the surreal. After starting out filming Camden’s music scene, he moved into writing, directing and composing his own work, earning a UK Music Video Award nomination early on. His short ROGER, starring John Bradley (Game of Thrones) and Seann Walsh, cemented his offbeat, character-driven voice. His films — including multiple shorts and a documentary — have screened at over 150 international festivals, including BAFTA and Academy-qualifying events, with several Méliès d’Argent nominations. He now works largely in dark sci-fi and horror-comedy, exploring flawed people, misbehaving technology, and the uneasy space between funny and disturbing. He is a member of BAFTA and Directors UK.",
